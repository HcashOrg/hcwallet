...
func (t *TicketPurchaser) ownTicketsInMempool() (int, error) {
	...
	if t.ticketAddress != nil {
		tiHashes, err := t.hcdChainSvr.GetRawMempool(hcjson.GRMAiTickets)
		if err != nil {
			return 0, err
		}
	...
	return int(curStakeInfo.AiOwnMempoolTix), nil
}
...
func (t *TicketPurchaser) allTicketsInMempool() (int, error) {
	tfi, err := t.hcdChainSvr.AiTicketFeeInfo(&zeroUint32, &zeroUint32)
	if err != nil {
		return 0, err
	}

	return int(tfi.AiFeeInfoMempool.Number), nil
}
