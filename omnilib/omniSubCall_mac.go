...
// #include "./omniproxy.h"
// #cgo CFLAGS: -I./
//#cgo LDFLAGS:-L./ -lomnicored -lbitcoin_server -lbitcoin_common -lunivalue -lbitcoin_util -lbitcoin_wallet  -lbitcoin_consensus -lbitcoin_crypto -lleveldb -lmemenv -lsecp256k1 /usr/local/lib/libboost_system.a /usr/local/lib/libboost_filesystem.a /usr/local/lib/libboost_program_options.a /usr/local/lib/libboost_thread.a /usr/local/lib/libboost_chrono.a /usr/local/lib/libdb_cxx.a /usr/local/lib/libssl.a /usr/local/lib/libcrypto.a  /usr/local/lib/libevent_pthreads.a /usr/local/lib/libevent.a -lm -ldl -lstdc++
import "C"
import (
	"unsafe"
	"fmt"
