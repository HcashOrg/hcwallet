...
//
//   https://github.com/HcashOrg/hcwallet/blob/master/rpc/documentation/api.md
//
// Any API changes must be performed according to the steps listed here:
//
//   https://github.com/HcashOrg/hcwallet/blob/master/rpc/documentation/serverchanges.md
package rpcserver
...
import (
	...
	pb "github.com/HcashOrg/hcwallet/rpc/walletrpc"
...
func (s *walletServer) ConstructTransaction(ctx context.Context, req *pb.ConstructTransactionRequest) (
	*pb.ConstructTransactionResponse, error) {
	...
	if req.ChangeDestination != nil {
		...
		changeSource = func(dbtx walletdb.ReadWriteTx, changeAddr hcutil.Address) ([]byte, uint16, error) { return script, version, nil }
	}
...
func marshalDecodedTxOutputs(mtx *wire.MsgTx, chainParams *chaincfg.Params) []*pb.DecodedTransaction_Output {
	...
	for i, v := range mtx.TxOut {
		...
		if (txType == stake.TxTypeSStx || txType == stake.TxTypeAiSStx) && (stake.IsStakeSubmissionTxOut(i)) {
